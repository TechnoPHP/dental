...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><h6>Update Group<?php echo $this->Html->link("Back to list", array("plugin"=>"iagents","controller"=>"aagentgroups","action"=>"index","admin"=>true),array("class"=>"btn btn-outline-info btn-sm float-right")); ?></h6>
					</div>
					<div class="card-body">
