...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading">Account Details Of <?php echo $agency['Agency']['name'];?> <div class="pull-right"><?php echo $this->Html->link("Add New", array("plugin"=>"iagents","controller"=>"agencies","action"=>"create","admin"=>true)); ?></div></header>
