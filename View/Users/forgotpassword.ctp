...
<div class="row">
	<div class="col-md-6">
		<h4>Let`s find your account with dental site</h4><hr>
		...
		<div class="row">
			<div class="col-md-6 form-group">
				<input name="" type="submit" value="Reset your password" class="btn btn-default" />
			</div>
			<div class="">						
	...
	<div class="col-md-5">
		...
		<ul class="list-common">
			...
			<li>Still an issue?&nbsp;mail to support@dental.site</li>
		</ul>
		<!-- ul class="list-common">
