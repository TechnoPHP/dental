		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					...
					Create New Group<div class="pull-right"><?php echo $this->Html->link("Back to list", array("controller"=>"groups","action"=>"index","admin"=>false)); ?></div>
					</header>
					<div class="panel-body">
						<?php echo $this->Form->create('Group', array("url"=>array("controller"=>"groups","action"=>"create","admin"=>false),"role"=>"form","class"=>"form-inline"));	?>
						<div class="col-md-3">
