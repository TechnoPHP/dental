...
<head>
	...
	<?php
		...
		echo $this->Html->css("admins/bootstrap-reset");
		echo $this->Html->css("font-awesome.min");
		echo $this->Html->css("admins/owl.carousel");
...
<script>if($('#flashMessage').hasClass('alert')){setInterval("$('.alert').hide('slow')","10000");}if($('#authMessage').hasClass('alert')){setInterval("$('.alert').hide('slow')","10000");}</script>
